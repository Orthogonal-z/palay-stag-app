            ...
            <View>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                        ...
                        <Text style={{ borderRadius: 2, color: COLORS.tab__color, backgroundColor: COLORS.bg__color, paddingHorizontal: 4, textAlign: 'center', paddingVertical: 2, fontSize: 12 }}>Cheapest</Text>
                    </View>
